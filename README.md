...
| 🗃️ [@netlify/database](packages/database)                   | TypeScript client for interacting with Netlify's managed database       | [![npm version](https://img.shields.io/npm/v/@netlify/database.svg)](https://www.npmjs.com/package/@netlify/database)                   |
